...
export async function generateMediaTweet(
    ...
    try {
        ...
        let tweetContent;
        const imgPrompt =
            "Generate a tweet and image prompt. For the image prompt, you MUST use the exact format below, but replace BOTH bracketed sections with your own creative descriptions. The first bracketed section needs a unique main scene (examples provided for inspiration), and the second bracketed section needs matching background elements that complement your scene.\n\n* A specific image prompt for a da Vinci-style painting study: \"A Renaissance-style painting in the authentic style of Leonardo da Vinci, blending techniques from Raphael and Titian. The painting depicts [REPLACE WITH YOUR UNIQUE SCENE - here are examples for inspiration: a serene landscape with rolling hills and distant villages, an intimate family portrait in a warmly lit interior, a close-up study of hands engaged in delicate work, a young woman's face with an enigmatic smile, a detailed study of flowing water around rocks, a modern cityscape where nature intertwines with architecture, a gathering of scholars in animated discussion, a portrait of a noble figure with intricate costume details, an astronaut floating amidst the starts and planets, a child's face full of wonder and curiosity, an artist's workshop filled with tools and experiments, a close-up of mechanical clockwork devices, or a quiet domestic scene with subtle interactions. Create something original while maintaining da Vinci's characteristic attention to detail and human elements]. The scene is crafted with da Vinci's signature sfumato technique, using translucent layers of paint to blend soft edges seamlessly. Figures and elements within the composition are precise yet stylized, avoiding photorealistic details while maintaining anatomical and spatial accuracy. Visible brushstrokes and layered pigments create a tactile, painted effect, with soft highlights of lead white and warm undertones of raw sienna for lifelike depth. The background is rendered with atmospheric perspective, depicting [REPLACE WITH YOUR OWN BACKGROUND ELEMENTS that complement your scene - examples: misty rolling hills, distant trees, a softly lit interior, etc]. The color palette is a harmonious blend of muted earthy tones such as ochre, burnt umber, olive green, and ultramarine blue, accented with hints of crimson and gold. The lighting is warm and diffused, casting natural shadows that are softly rendered using deep glazes to enhance depth and realism. The painting replicates the texture of Renaissance oil paintings on wood panels, with faint craquelure and a slightly aged varnish sheen. Subtle imperfections, like uneven layering of paint, evoke the hand-crafted mastery of da Vinci. Brushstrokes are visible everywhere 100%, enhancing the authentic feel of the piece. The composition captures an ethereal, timeless quality, with a focus on soft transitions, organic realism, and painterly details that reflect the Renaissance legacy\"";
        try {
